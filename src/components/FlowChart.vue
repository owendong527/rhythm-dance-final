<template>
  <div class="container mt-10 px-5">
    <div class="position-relative my-4 mx-auto" style="height: 30px; max-width: 900px; width: 90%;">
      ...
      translate-middle btn btn-sm btn-secondary rounded-pill border"
        style="width: 2rem; height: 2rem"
      >
        1
      </div>
      <p class="position-absolute top-100 start-0 translate-middle">填寫資料</p>
      <div class="position-absolute top-0 start-50 translate-middle btn btn-sm rounded-pill border"
      ...
      <div class="position-absolute top-0 start-100 translate-middle btn btn-sm rounded-pill border"
...
export default {
  ...
  data() {
    return {
      progress: this.outProgress,
    };
  },
  watch: {
    outProgress(newValue) {
