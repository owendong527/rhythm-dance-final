          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="mb-2">
                ...
                class="form-control" ref="fileInput" @change="uploadFile" />
              </div>
              ...
              <!--
                ...
                -->
              <div v-if="!tempProduct.imagesUrl.length || tempProduct.imagesUrl
            ...
            <div class="col-sm-8">
              ...
              <div class="row">
                <div class="mb-3 col-md-6">
                  ...
                  class="form-control" placeholder="請輸入分類" v-model="tempProduct.category">
                </div>
                <div class="mb-3 col-md-6">
              ...
              <div class="mb-3 col-md-6">
                ...
                class="form-control" placeholder="請輸入youtube連結" v-model="tempProduct.youtubeLink">
              </div>
              <div class="mb-3 col-md-12" v-if="typeof(tempProduct.youtubeLink) === 'string'">
                <iframe width="100%" height="400" :src="`${tempProduct.youtubeLink}?rel=0`"
              ...
              <div class="mb-3">
                ...
                <textarea id="description" type="text" class="form-control" rows="5"
              ...
              <div class="mb-3 d-flex">
                ...
                <div class="form-check form-switch ms-4">
                  <input class="form-check-input "
                  type="checkbox" role="switch" id="is_love"
                  :true-value="1" :false-value="0" v-model="tempProduct.is_love">
...
export default {
  ...
  data() {
    return {
      tempProduct: {}, // tempProduct是 editProduct , product是 tempProduct
      status: {},
    };
  },
  watch: {
    product() {
      this.tempProduct = this.product; // 因為傳參考不能去改傳入的值，所以用另外一個變數名稱去接
    },
  },
  methods: {
